...
describe('DefaultSessionManager', () => {
  ...
  describe('createSession', () => {
    it('should create a new session', async () => {
      const session = await sessionManager.createSession(testUser, testClientInfo, 'oauth');
    ...
    it('should enforce max concurrent sessions', async () => {
      ...
      const newSession = await sessionManager.createSession(testUser, testClientInfo, 'oauth');
  ...
  describe('getUserSessions', () => {
    it('should return all user sessions', async () => {
      const session1 = await sessionManager.createSession(testUser, testClientInfo, 'oauth');
      const session2 = await sessionManager.createSession(testUser, testClientInfo, 'norwegian-id');
  ...
  describe('cleanupExpiredSessions', () => {
    it('should remove expired sessions', async () => {
      const session1 = await sessionManager.createSession(testUser, testClientInfo, 'oauth');
      const session2 = await sessionManager.createSession(testUser, testClientInfo, 'oauth');
