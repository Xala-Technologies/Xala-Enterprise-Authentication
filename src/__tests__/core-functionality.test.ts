...
import { createTypeSafeConfig, validateRequiredFields } from '../utils/type-safety';
...
describe('Core Functionality', () => {
  describe('Configuration Validation', () => {
    ...
    it('should validate required fields', () => {
      const requiredFields = ['nsmClassification', 'gdprCompliant', 'sessionTimeout'];
      const validData = {
  ...
  describe('Type Safety Utilities', () => {
    ...
    it('should enforce NSM classification hierarchy', () => {
      ...
      classifications.forEach(classification => {
        expect(hierarchy[classification as keyof typeof hierarchy]).toBeGreaterThanOrEqual(0);
      });
